...
class Accounts extends ModelService {
    ...
    public function aList($page = 1, $limit = 10, $search = []) {
        ...
        $field = ['id','uid','channel_id','df_id','day','total_orders','total_fee_all','total_fee_paid','total_paid','rate','total_fee','type','title','platform','withdraw_id','update_at','do_orders','do_fee','agent'];
