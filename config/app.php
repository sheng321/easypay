...
return [
    ...
    'app_debugs'              => true,
    // 单独页面开启应用调试模式 自定义
    'debug_token'       => 'e10adc3949ba59abbe56e057f20f883e',
    ...
    'default_filter'         => 'trim,htmlspecialchars,addslashes,strip_tags,remove_xss',
    // 默认语言
    'default_lang'           => 'zh-cn',
    // 应用类库后缀
    'class_suffix'           => false,
    ...
    'dispatch_api_tmpl'    => Env::get('app_path') . '/common/view/tpl/pay_jump.tpl',
